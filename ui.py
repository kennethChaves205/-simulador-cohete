...
class RocketSimulatorApp:
    ...
    def _build_layout(self) -> None:
        """Crea el layout general: panel izquierdo (controles) y derecho (gráficas)."""
    ...
    def _build_plot_panel(self, parent: ttk.Frame) -> None:
        """Panel derecho: gráficas en tiempo real."""
        self._plot_manager = PlotManager(parent)
